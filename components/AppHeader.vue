...
<template>
  <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm fixed top-0 left-0">
    <nav class="mt-6 relative max-w-7xl w-full bg-white border border-gray-200 
    backdrop-blur-sm bg-opacity-70 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700 dark:backdrop-blur-sm dark:bg-opacity-70"  aria-label="Global">
